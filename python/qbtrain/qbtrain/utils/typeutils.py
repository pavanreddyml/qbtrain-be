# qbtrain/utils/typeutils.py
from __future__ import annotations

import inspect
import json
from typing import Any, Callable, Dict, List, Optional, Tuple, get_args, get_origin, get_type_hints, Literal, Union

def get_stored_procedure_signatures(self, functions) -> Optional[str]:
        if not functions:
            return None
